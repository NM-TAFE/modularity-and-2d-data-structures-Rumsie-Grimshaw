...
class TestTicTacToe(unittest.TestCase):
    ...
    def test_space_already_taken(self, game_board):
        # Arrange
        first_player = '0'
        second_player = 'X'
        index = 5
        ...
        # Act
        game_board.update_board(first_player, value=index)
        game_board.update_board(second_player, value=index)
        result = game_board.board[index]
